...
if __name__ == "__main__":
    ...
    #FederatedClient("172.31.20.224, datasource_CIFAR10.Cifar10, fo_name, f_training_name)
    FederatedClient("172.31.20.224", 5000, datasource.Mnist, fo_name, f_training_name)
